...
(function(d, h, l, m) {
    var k = {
        init: function(b, a) {
            ...
            c.options.tint && (c.options.lensColour = "none",
        ...
        setWindowPostition: function(b) {
            ...
            if (isNaN(a.options.zoomWindowPosition))
                ...
                case 5:
                    ...
                    break;
                case 6:
                    a.options.zoomWindowHeight > a.nzHeight && (a.windowOffsetTop = a.nzHeight,
            ...
            if ("window" == a.options.zoomType || "inner" == a.options.zoomType)
                1 == a.zoomLock && (1 >= a.widthRatio && (a.windowLeftPos = 0),
        ...
        swapAction: function(b, a) {
            ...
            if (c.options.imageCrossfade) {
                ...
                c.$elem.attr("src", b),
                c.options.tint && (c.zoomTintImage.attr("src", a),
                ...
                c.zoomContainer.css("height", c.$elem.height()),
                c.zoomContainer.css("width", c.$elem.width());
            c.options.imageCrossfade && (c.zoomWrap.css("height", c.$elem.height()),
            ...
            c.options.imageCrossfade ? (c.zoomWrap.css("height", c.options.constrainSize),
            c.zoomWrap.css("width", "auto"),
            c.constwidth = c.zoomWrap.width()) : (c.$elem.css("height", c.options.constrainSize),
            c.$elem.css("width", "auto"),
            c.constwidth = c.$elem.width()),
            "inner" == c.options.zoomType && (c.zoomWrap.parent().css("height", c.options.constrainSize),
            ...
            c.options.tint && (c.tintContainer.css("height", c.options.constrainSize),
            ...
            "width" == c.options.constrainType && (c.zoomContainer.css("height", "auto"),
            c.zoomContainer.css("width", c.options.constrainSize),
            c.options.imageCrossfade ? (c.zoomWrap.css("height", "auto"),
            c.zoomWrap.css("width", c.options.constrainSize),
            c.constheight = c.zoomWrap.height()) : (c.$elem.css("height", "auto"),
            ...
            c.options.tint && (c.tintContainer.css("height", c.constheight),
